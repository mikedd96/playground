...
function startertheme_scripts() {
	wp_enqueue_style( 'startertheme-style', get_stylesheet_directory_uri() . './css/style.min.css');
	...
	wp_enqueue_script( 'theme-script', get_template_directory_uri() . '/dist/js/script.js', array(), '20190731', true );
